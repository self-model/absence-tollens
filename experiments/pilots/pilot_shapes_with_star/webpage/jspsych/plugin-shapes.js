  ...
  "use strict"; // what is this
    ...
    const info = {
      ...
      parameters: {
        ...
        rare_option: {
          type: jspsych.ParameterType.STRING,
          pretty_name: "Rare option",
          default: false,
          description: "One of the choice options is a rare shape (star). Used here specifically for left-occluder, not-triangle trial."
        }
      }
    }
      ...
      let sketch = (p) => {
         ...
         // choices 'press S' and 'press G'
          ...
          if (trial.occluder === 'right') {
            ...
            if (trial.rare_option) {
              options = [0,5]; // circle and star
            } else {
              options[0] = 0; // circle
